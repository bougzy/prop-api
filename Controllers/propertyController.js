...
exports.getAllProperties = async (req, res) => {
  try {
    ...
    console.log(`Fetching properties: page=${page}, limit=${limit}, search=${search}`);
    ...
    console.log(`Total properties: ${totalProperties}, Fetched properties: ${properties.length}`);
...
// exports.updateProperty = async (req, res) => {
//   try {
//     const { name, description, location, address, phoneNumber, localGovernment } =
//       req.body;
